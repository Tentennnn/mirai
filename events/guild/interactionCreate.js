			...
			if (interaction.isCommand()) {
                    ...
                    if (command.premium && premiumServer && !premiumServer.isPremium) {
                        return interaction.reply({
                            embeds: [new MessageEmbed()
                                ...
                                Join **[TEN Devolopment](${process.env.spServer})** And **Open a Ticket!**`)
                                .setColor("#FFFF00")
                            ],
                            ephemeral: true
                        })
                ...
                commandLogsChannel.send({
                    embeds: [new MessageEmbed()
                        ...
                        .setTitle(`<:join:906786246767038515> Slash Command`)
                        .addField("**<:join:906786246767038515> Author**", `\`\`\`${interaction.user.tag}\`\`\``)
