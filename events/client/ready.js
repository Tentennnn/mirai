...
module.exports = {
  ...
  async execute(client) {
    try {
      ...
      // Auto Status
      var activites = [
        `m/help | on ${client.guilds.cache.size} Servers, with ${Math.ceil(client.users.cache.size / 1000)}k Members`,
        `m/play | m/autoplay`,
        `m/invite | m/support`,
        `${process.env.PREFIX}help | ${process.env.PREFIX}help moderation`,
      ],
        i = 0;
